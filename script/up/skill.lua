...
local event_name = {
	...
	['on_cast_start']   = {20003,EVENT.ABILITY_PS_START,'技能-前摇开始'},
	['on_cast_channel'] = {20004,EVENT.ABILITY_PS_END,'技能-施法引导'},
	['on_cast_shot']    = {20005,EVENT.ABILITY_SP_END,'技能-施法出手'},
	['on_cast_finish']  = {20006,EVENT.ABILITY_CST_END,'技能-施法完成'},
	--['on_cast_break']   = '技能-施法打断',
	--['on_cast_channel'] = '技能-施法引导',
	--['on_cast_shot']    = '技能-施法出手',
	--['on_cast_finish']  = '技能-施法完成',
	['on_cast_stop']    = {20008,EVENT.ABILITY_END,'技能-施法停止'},
	--['is_conditions']	= '技能-是否符合条件',
	['on_start']    = {20009,EVENT.ABILITY_CS_START,'技能-发布命令'},
    ['on_build']        = {20010,EVENT.ABILITY_BUILD_FINISH,'技能-建造完成'},
}
