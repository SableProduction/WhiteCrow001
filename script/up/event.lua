...
local event_list = {
    ...
    {EVENT.KILL_UNIT,'单位-击杀',{{'__source_unit','unit'}},true},  --__damage	伤害值	Fixed  __source_unit	杀手单位	Unit   __target_unit	死亡单位	Unit  __ability	致命伤害所属技能	Ability   __damage_type	致命伤害类型	Int32   __unit_id	单位ID
    ...
    {EVENT.UNIT_REMOVE_ITEM,'单位-失去物品'},
    {EVENT.UNIT_BE_HURT,'单位-被攻击',{{'__target_unit','unit'},{'__source_unit','unit'},{'__ability','skill'},'__damage','__damage_type'},true},
    {EVENT.KEYBOARD_KEY_UP_EVENT,'键盘-抬起',{'__current_key',{'__role_id','player'}}},
    {EVENT.KEYBOARD_KEY_DOWN_EVENT,'键盘-按下',{'__current_key',{'__role_id','player'}}},
    {EVENT.UNIT_ON_COMMAND,'单位-收到指令',{{'__unit_id','unit'},'__cmd_type'}},
    {EVENT.UNIT_REMOVE,'单位-删除',{{'__unit_id','unit'}}},
    ...
    {EVENT.AREA_ENTER,'单位-进入区域'},--nil,nil,'AREA',1180593723},--,{{'__unit_id','unit'},'__area_id'}},
    ...
    {EVENT.ABILITY_PS_END,'技能-前摇结束',{{'__ability','skill'}}},
    {EVENT.ABILITY_END,'技能-结束',{{'__ability','skill'}}},
...
--注册自定义事件
for _,v in pairs(CUSTOM_EVENT_LIST) do
    local a = {{EVENT.CUSTOM_EVENT,v},'自定义-'..v,{'__c_param_1','__c_param_2','__c_param_3','__c_param_4','__c_param_5'}}
    table.insert(event_list,a)
end
